...
for ii=2:length(duracao_nan_index_global)
    ...
    if(duracao_nan_index_global(ii) > 3)
        ...
        clear coef
        coef = ut_solv ( vetor_tempo_analise', u_sup_adcp(1:ini_nan_index_global(ii)-1),v_sup_adcp(1:ini_nan_index_global(ii)-1), -22.8219,'auto','Andrews');
        ...
        u_sup_adcp = u_sup_adcp + 100;
        
        % Ajuste de offset - média entre valores antes e depois da lacuna:        
        u_antes=u_sup_adcp(ini_nan_index_global(ii)-1);
        u_depois=u_sup_adcp(fim_nan_index_global(ii)+1);
        ...
        u_sup_adcp(ini_nan_index_global(ii):fim_nan_index_global(ii)) = previsao_ajustada;
        ...
        v_sup_adcp = v_sup_adcp + 100;
        
        % Ajuste de offset - média entre valores antes e depois da lacuna: 
        v_antes=v_sup_adcp(ini_nan_index_global(ii)-1);
        v_depois=v_sup_adcp(fim_nan_index_global(ii)+1);
        ...
        v_sup_adcp(ini_nan_index_global(ii):fim_nan_index_global(ii)) = previsao_ajustada;
